...
public partial class LounasookFotoPage : ContentPage
{
    ...
    private void LoadImages()
    {
        ...
        var data = database.GetLounasook()
        ...
        foreach (var item in data)
        {
            ...
            var tempFile = Path.Combine(FileSystem.CacheDirectory, $"lounasook_{item.Lounasook_id}.jpg");
            ...
            {
                await Navigation.PushAsync(new LounasookDetailPage(item));
            };
