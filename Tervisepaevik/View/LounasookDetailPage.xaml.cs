...
public partial class LounasookDetailPage : ContentPage
{
    private LounasookClass item;
    ...
    public LounasookDetailPage(LounasookClass selected)
    {
        item = selected;
    ...
    private void UpdateCalories()
    {
        ...
        // 🔹 цвет для обеда (другой диапазон)
